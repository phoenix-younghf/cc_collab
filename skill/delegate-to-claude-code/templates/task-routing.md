...
- Ambiguous requests needing user clarification
- Tasks without testable acceptance criteria
- Integration and final merge decisions
- Any closeout requiring policy exceptions

## Required Inputs Before Delegation

- Task objective and scope boundary
